# SpectralPainting
This page is dedicated to providing files and instructions related to creating spectrogram "spectral paintings" using open-source tools. It accompanies [a Youtube video](https://youtu.be/nb42YGBrDIA) that will walk the user through the theory behind how "spectral painting" works. This will provide similar functionality as [gr-paint](https://github.com/drmpeg/gr-paint), but only uses common blocks in Gnu Radio Companion, as well as some other open source tools.
