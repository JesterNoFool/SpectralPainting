...
* Use Gimp to resize (rescale) the image and, if necessary, flip the image top to bottom. You'll need to flip the image if the spectrogram is a falling raster (scrolls downward).
* Use Gnu Octave to convert the image file into a file of real-only 32-bit floating point numbers (.rf32).
* Use Gnu Radio Companion to:
